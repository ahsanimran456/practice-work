...
const firebaseConfig = {
  apiKey: "AIzaSyAmlzVDt0FYQ8Egw9qRftxbiWvqxjGybxg",
  ...
  appId: "1:753893351291:web:2f6463db147bb0181a67de",
  measurementId: "G-M3QYSWKK44"
};
...
const getAllUsers = async (email, currentId, currentName) => {
  ...
  querySnapshot.forEach((doc) => {
    users.innerHTML += `<li>${doc.data().name} <button onclick='startChat("${doc.id}","${doc.data().name}","${currentId}","${currentName}")' id="chat-btn">Start Chat</button></li>`;
  });
};
